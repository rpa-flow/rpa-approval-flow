...
export const updateInvoiceSchema = z
  .object({
    ...
    ordemCompra: z.string().trim().regex(/^\d+$/, "Informe somente números.").max(120).nullable().optional(),
    ocContrato: z.string().trim().regex(/^\d+$/, "Informe somente números.").max(120).nullable().optional(),
